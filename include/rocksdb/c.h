...
enum {
  ...
  rocksdb_block_read_count_l2,
  rocksdb_block_read_byte,
  rocksdb_block_read_time,
  rocksdb_block_read_time_l0,
  rocksdb_block_read_time_l1,
  rocksdb_block_read_time_l2,
  ...
  rocksdb_read_index_block_a,
  rocksdb_read_index_block_b,
  rocksdb_read_index_block_c,
  rocksdb_read_index_block_d,
  rocksdb_read_index_block_count,
