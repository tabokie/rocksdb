...
struct PerfContext {
  ...
  uint64_t block_read_count_l2;
  uint64_t block_read_byte;            // total number of bytes from block reads
  uint64_t block_read_time;            // total nanos spent on block reads
  uint64_t block_read_time_l0;
  uint64_t block_read_time_l1;
  uint64_t block_read_time_l2;
  ...
  uint64_t get_from_output_files_count;
  ...
  uint64_t read_index_block_a;
  uint64_t read_index_block_b;
  uint64_t read_index_block_c;
  uint64_t read_index_block_d;
  ...
  uint64_t new_table_block_iter_nocached_nanos;
  uint64_t new_index_block_iter_nanos;
